...
# CONFIG_SECURITY (6.9.7ore3)
# CONFIG_HARDENED_USERCOPY (6.9.7ore4)
# CONFIG_FORTIFY_SOURCE (6.9.7ore5)

# Memory initialization
# CONFIG_INIT_ON_ALLOC_DEFAULT_ON (6.9.7ore6)
```
...
# CONFIG_CRYPTO_SM4_GENERIC (6.6.8ore3)
# CONFIG_CRYPTO_TWOFISH (6.6.8ore4)

# Length-preserving ciphers and modes
# CONFIG_CRYPTO_ADIANTUM (6.6.8ore5)
# CONFIG_CRYPTO_CFB (6.7.2ore1)
# CONFIG_CRYPTO_CTS (6.7.2ore2)
# CONFIG_CRYPTO_HCTR2 (6.7.6ore1)
# CONFIG_CRYPTO_KEYWRAP (6.8.2ore1)
# CONFIG_CRYPTO_LRW (6.8.2ore2)
# CONFIG_CRYPTO_XTS (6.8.2ore3)

# AEAD chiphers
# CONFIG_CRYPTO_AEGIS128 (6.8.2ore4)

# Hash, digest, mac
# CONFIG_CRYPTO_RMD160 (6.8.2ore5)
# CONFIG_CRYPTO_SM3_GENERIC (6.8.2ore6)
# CONFIG_CRYPTO_STREEBOG (6.8.2ore7)
# CONFIG_CRYPTO_VMAC (6.8.8ore1)
# CONFIG_CRYPTO_WP512 (6.9.3ore1)
# CONFIG_CRYPTO_XCBC (6.9.3ore2)
